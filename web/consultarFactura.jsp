    ...
    <div class="content">
        <div class="card bg-white" style="width: 100%">
            ...
            <div class="card-body " >
                ...
                <form name="ReporteUsuarios" action="GenerarPDF_Factura.jsp" target="_blank" class="derecha pull-right">
                    <button class="btn btn-dark btn-lg " type="submit"><i class="mdi mdi-file-pdf mdi-24px mr-2"></i> Generar PDF Factura</button>
                </form>
