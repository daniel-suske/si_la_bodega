<%-- 
    Document   : MiReparacion
    Created on : 2/12/2020, 09:47:03 AM
    Author     : Yeison
--%>
    ...
    <div class="content">
        <div class="card bg-white justify-content-center">
            <div class="card-body ">
                ...
                <h1 class="text text-dark">Mis Reparaciones</h1>
                <hr>
                        ...
                        <tbody> 
                            ...
                            <%
                                if (request.getAttribute("validacion") == null) {
                                    ...
                                    ArrayList<ReparacionVO> listaVehiculosCL = repDAO.listarCL(IdU);
                                    ...
                                    for (int i = 0; i < listaVehiculosCL.size(); i++) {
                                        repVO = listaVehiculosCL.get(i);%> 
...
<script>
        ...
        document.getElementById(`reparacion_cliente`).classList.add("active");
</script>      