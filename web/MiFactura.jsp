<%-- 
    Document   : MiFactura
    Created on : 3/12/2020, 07:32:12 PM
    Author     : Yeison
--%>
                ...
                <div class="content">
                    <div class="card bg-white justify-content-center">
                        <div class="card-body ">
                            ...
                            <h1 class="text text-dark">Mis Facturas</h1>
                            <hr>
                    ...
                    <tbody >
                        <%
                            ...
                            if (fasVO == null) {
                                ...
                                ArrayList<FacturaVO> ListaFacturasCL = faDAO.listarCL(IdU);
                                for (int i = 0; i < ListaFacturasCL.size(); i++) {

                                    faVO = ListaFacturasCL.get(i);
                        %>                              
...
<script>
        ...
        document.getElementById(`factura_cliente`).classList.add("active");
</script>     