<%-- 
    Document   : MiProducto
    Created on : 1/12/2020, 06:29:07 PM
    Author     : Yeison
--%>
    ...
    <div class="content">
        <div class="card bg-white justify-content-center">
            <div class="card-body ">
                ...
                <h1 class="text text-dark">Mis Productos</h1>
                <hr>
                          ...
                          <%
                            ...
                            if ( request.getAttribute("Producto") == null) {
                               ...
                               ProductoVO PoVO = new ProductoVO();
                                ArrayList<ProductoVO> ListaProductosCL = PaDAO.listarPCL(IdU);
                                for (int i = 0; i < ListaProductosCL.size(); i++) {

                                    PoVO = ListaProductosCL.get(i);
                        %>
...
<script>
        ...
        document.getElementById(`producto_cliente`).classList.add("active");
</script>