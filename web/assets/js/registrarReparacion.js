...
const validarFormulario = (e) => {
    switch (e.target.name) {
        case "descripcion":
            ...
            break;
        case "id_servicio":
            validarSelect(e.target, 'id_servicio'); 
            break;
        case "id_producto":
            validarSelect(e.target, 'id_producto'); 
            break;
        case "tecnico":
            validarSelect(e.target, 'tecnico'); 
            break;
        case "costos":
            validarCampo(expresiones.costos , e.target, 'costos');
            break;
        case "dates":
            validarSelect(e.target, 'dates'); 
            break;
...
/*
         valoru=datos.valor;*/
            ...
            cantidadR=parseInt(datos.array.Cantidad);
            ...
            total_subtotal+=subtotal;
             ...
             alert("La cantidad solicitada del Repuesto no se encuentra en el sistema")
         }
