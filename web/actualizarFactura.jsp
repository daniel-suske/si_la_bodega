                    ...
                    <form class="form"  method="post" action="Factura" id="form">
                        ...
                        <div class="form-row content ">
                            ...
                            <div class="form-group col-md-6" id="grupo__servicio">
                                ...
                                <div class="formulario__grupo-input ">
                                    <select name="servicio"  class="form-control-lg col-lg-11">
                            ...
                            <div class="form-group col-md-6 " id="grupo__pago">
                                ...
                                <div class="formulario__grupo-input">
                                    <select id="pago" name="pago" class="form-control-lg col-lg-11">
                                        <% String P= faVO.getTipo_Pago();
                                        if (P.equals("EF")) {
                         
                                        %>
                                        <option value="<%=faVO.getTipo_Pago()%>" selected="">EFECTIVO</option>
                                        <option value="TD" >TARJETA DEBITO</option>
                                        <%}else{%>
                                      <option value="EF">EFECTIVO</option>
                                      <option value="<%=faVO.getTipo_Pago()%>" selected="">TARJETA DEBITO</option>  
                                      <% }%>
                        ...
                        <div class="form-row content">
                            <div class="form-group col-md-6" id="grupo_garantia">
                                ...
                                <div class="formulario__grupo-input">
                                    ...
                                    <select id="garantia" name="garantia" class="form-control-lg col-lg-11">
                                        <% String G = faVO.getGarantia();
                                            if (G.equals("SI")) {


                                        %>

                                        <option value="<%=faVO.getGarantia()%>" selected="" >SI TIENE GARANTIA</option>
                                        <option value="NO">NO TIENE GARANTIA</option>
                                        <%} else {

                                            %>
                                        <option value="SI"  >SI TIENE GARANTIA</option>
                                        <option value="<%=faVO.getGarantia()%>" selected="" >NO TIENE GARANTIA</option>
                                        <%}%>
                                    </select>
                                </div>
                            ...
                            <div class="form-group col-md-6" id="grupo_recibe">
                                ...
                                <div class="formulario__grupo-input">
                                    ...
                                    <select name="recibe" class="form-control-lg col-lg-11">
                                        <option value=""> Seleccione...</option>
                                        <%
